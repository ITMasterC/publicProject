...
class CLoadMgr {
    ...
    constructor() {}
    /** 音乐音效配置 */
    private MusicCF: { [key: string]: CKEY.UIConf } = {};
    /** 图集字典 */
    private dictAtlas = {};
    /**图片字典 */
    ...
    */
    public preLoad(completedCallback?, progressCallback?:(completedCount,totalCount)=> void) {
        ...
        console.log("【首屏资源配置】CKEY.preRes:", this._preRes);
    }
    /**
     *  顺序加载
     * @param completedCallback 完成回调res
    ...
    * @param name 音频名称
    */
    public getMusicUrl(name: string) {
        return this.MusicCF[name].url;
    }
  ...
  private conventType(type: string) {
    switch (type) {
        case CKEY.ResType.AudioClip: { return cc.AudioClip; }
        case CKEY.ResType.JsonAsset: { return cc.JsonAsset; }
        case CKEY.ResType.Prefab: { return cc.Prefab; }
        case CKEY.ResType.SpriteAtlas: { return cc.SpriteAtlas; }
        case CKEY.ResType.SpriteFrame: { return cc.SpriteFrame; }
        case CKEY.ResType.TextAsset: { return cc.TextAsset; }
    }
}
    /**
     * 缓存资源
